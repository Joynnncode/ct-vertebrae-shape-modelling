...
folder1="../q3dv_tools2023/points_avg"
folder2="../q3dv_tools2023/output_points40(15)"
#folder1="../q3dv_tools2023/hxavg"
#folder2="../q3dv_tools2023/yjavg"
#folder2="../points_avg4"
#folder1="D:/desktop/Dissertation/Annotation/q3dv_tools2023/points_hx1"
#folder2="D:/desktop/Dissertation/Annotation/q3dv_tools2023/points_hx2"
...
for i in range(n_files): 
    ...
    dpts=pts2-pts1
    #print ((pts2-pts1)/2) # calculate the mean positions
...
print(f"Overall mean distance between points = {np.mean(mean_d):.2f}")
